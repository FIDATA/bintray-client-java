 ...
 * @author Dan Feldman
 */
class ProprietaryLicenseHandleImpl implements ProprietaryLicenseHandle {
    private static final Logger log = LoggerFactory.getLogger(ProprietaryLicenseHandleImpl.class);
    ...
    ProprietaryLicenseHandleImpl(BintrayImpl bintrayHandle, RepositoryHandle repositoryHandle, String name) {
    ...
    @Override
    public Propri get() throws IOException, BintrayCallException {
